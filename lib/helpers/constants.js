...
//
var csts = {
  PREFIX_MSG                    : chalk.green.bold('[DEVAID] '),
  PREFIX_MSG_INFO               : chalk.cyan.bold('[DEVAID][INFO] '),
  PREFIX_MSG_VALIDATION_ERROR   : chalk.red.bold('[DEVAID][VALIDATION] '),
  PREFIX_MSG_ERR                : chalk.red.bold('[DEVAID][ERROR] '),
  PREFIX_MSG_WARNING            : chalk.yellow.bold('[DEVAID][WARN] '),
  PREFIX_MSG_SUCCESS            : chalk.green.bold('[DEVAID] '),
